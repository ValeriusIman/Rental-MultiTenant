 ...
 *
 * @package    app
 * @subpackage Models\Dao\Dao\Relation
...
class ContactPersonDao extends AbstractBaseDao
{
    ...
    public static function loadData(array $wheres = [], array $orders = [], int $limit = 0, int $offset = 0): array
    {
        ...
        $query = 'SELECT cp.cp_id, cp.cp_ss_id, cp.cp_name, cp.cp_phone, cp.cp_address, cp.cp_active
                        FROM contact_person as cp ' . $strWhere;
