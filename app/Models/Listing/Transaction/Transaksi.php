...
namespace App\Models\Listing\Transaction;
 ...
 * @copyright  2021 Multi Mutiara Rental.
 */
class Transaksi extends AbstractListingModel
{
    /**
    ...
    {
        parent::__construct('tr', 'transaksi');
        $this->Table->setTitle(Trans::getWord('transaksi'));
    }
    ...
    public function loadResultTable(): void
    {
        ...
        $this->Table->setEnableButtonNew(false);
        $this->Table->setEnableButtonEdit(false);
        $this->Table->setEnableButtonView('tr_id');
...
//        dd(TransaksiDao::loadData($this->getWhereCondition(), $orderBys));
        return TransaksiDao::loadData($this->getWhereCondition(), $orderBys);
    }
